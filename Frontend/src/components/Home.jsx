  ...
  return (
    <div className="bg-slate-950 text-white scroll-smooth">
          ...
          {token ? (
            ...
            <>
              ...
              <button
                ...
                className="px-5 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold transition duration-300"
              >
                Sign Up
              </button>
            </>
      ...
      <section className="max-w-5xl mx-auto text-center px-6 pt-24 pb-32">
        ...
        <div className="flex justify-center gap-6">
          <button
            ...
            className="px-8 py-3 rounded-xl bg-purple-600 hover:bg-purple-700 text-white transition duration-300"
          >
            Create Portfolio
          </button>
          ...
          <button
            onClick={() => navigate("/portfolio")}
            className="px-8 py-3 rounded-xl border border-slate-700 hover:border-purple-500 hover:bg-purple-500/10 transition duration-300"
          >
            Explore Profiles
          </button>
        </div>
      ...
      <section className="bg-slate-900 py-24">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="p-8 rounded-2xl bg-slate-800 hover:bg-slate-700 hover:-translate-y-2 transition-all duration-300">
      ...
      <section className="bg-slate-900 py-24 text-center">
        ...
        <button
          onClick={() => navigate("/signup")}
          className="px-10 py-4 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg transition duration-300"
        >
          Join CareerLens
        </button>
      </section>
