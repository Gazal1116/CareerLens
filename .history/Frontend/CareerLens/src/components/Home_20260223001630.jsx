    ...
    <div className="bg-slate-950 text-white scroll-smooth">
      ...
      <nav className="max-w-7xl mx-auto flex justify-between items-center px-6 py-6">
        ...
        <div className="flex gap-6 items-center">
          <button className="text-slate-300 hover:text-white transition duration-300">
            Login
          </button>
      ...
      <section className="max-w-5xl mx-auto text-center px-6 pt-24 pb-32">
        ...
        <div className="flex justify-center gap-6">
          <button className="px-8 py-3 rounded-xl bg-purple-600 
          hover:bg-purple-700 
          ...
          <button className="px-8 py-3 rounded-xl border border-slate-700 
      ...
      <section className="bg-slate-900 py-24 text-center">
        ...
        <button className="px-10 py-4 rounded-xl bg-purple-600 
        hover:bg-purple-700 
        hover:shadow-xl hover:shadow-purple-500/40
        hover:-translate-y-1
        active:scale-95 
