...
app.post("/api/portfolio/:id/rate", protect, async (req, res) => {
  const { rating, comment } = req.body;

  const portfolio = await Portfolio.findById(req.params.id);

  const alreadyRated = portfolio.ratings.find(
...
// ----------- DELETE PORTFOLIO -------------
app.delete("/api/portfolio/:id", protect, async (req, res) => {
  try {
    console.log("Delete request for portfolio:", req.params.id);
    console.log("User ID:", req.user.id);
    ...
    console.log("Portfolio owner:", portfolio.user.toString());

    if (portfolio.user.toString() !== req.user.id) {
      console.log("Not authorized - portfolio owner is", portfolio.user.toString(), "but user is", req.user.id);
...
// ----------- EDIT PORTFOLIO -------------
app.put("/api/portfolio/:id", protect, async (req, res) => {
  try {
    console.log("Edit request for portfolio:", req.params.id);
    console.log("User ID:", req.user.id);
